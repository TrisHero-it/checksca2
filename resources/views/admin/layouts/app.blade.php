...
<head>
    ...
    <title>Admin - CheckSca.com</title>
    ...
    <div
        ...
        <div class="navbar-brand header-logo">
            <a href="/" class="b-brand">
                ...
                <img src="{{asset('images/design/favicon_io/android-chrome-192x192.png')}}" style="width: 30px; height: 30px" alt="logo" class="logo-thumb images">
            </a>
            ...
            <ul class="nav pcoded-inner-navbar sidenav-inner">
                ...
                <li data-username="dashboard default ecommerce sales Helpdesk ticket CRM analytics project"
                    ...
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span
                            class="pcoded-mtext">Bài viết tố cáo</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="/admin-reports" class="">Danh sách @if($reportWaiting!=0)
                                    <span
                                        class="pcoded-badge label label-danger">{{$reportWaiting}}</span>
                        @endif</a></li>
                        <li class=""><a href="{{route('request.remove.post.index')}}" class="">Yêu cầu gỡ bài viết</a></li>
                ...
                <li data-username="basic components button alert badges breadcrumb pagination progress tooltip popovers carousel cards collapse tabs pills modal spinner grid system toasts typography extra shadows embeds"
                    ...
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-box"></i></span><span
                            class="pcoded-mtext">Danh mục</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('categories.index')}}" class="">Danh sách</a></li>
                        <li class=""><a href="{{route('categories.create')}}" class="">Thêm danh mục</a></li>
                    </ul>
                </li>
                ...
                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layers"></i></span><span
                            class="pcoded-mtext">Quảng cáo</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('ads.index')}}" class="">Danh sách</a></li>
                    </ul>
                </li>

                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layers"></i></span><span
                            class="pcoded-mtext">Tài khoản</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('admin.accounts.index')}}" class="">Danh sách</a></li>
                        <li class=""><a href="{{route('admin.accounts.create')}}" class="">Thêm admin</a></li>
                    </ul>
                </li>
                ...
                <li data-username="basic components button alert badges breadcrumb pagination progress tooltip popovers carousel cards collapse tabs pills modal spinner grid system toasts typography extra shadows embeds"
                    class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-box"></i></span><span
                            class="pcoded-mtext">Tin tức</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('admin-news.index')}}" class="">Danh sách</a></li>
                        <li class=""><a href="{{route('admin-news.create')}}" class="">Thêm tin tức</a></li>
                        <li class=""><a href="{{route('admin-news.create2')}}" class="">Thêm tin tức v.2</a></li>
                    </ul>
                </li>

                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layers"></i></span><span
                            class="pcoded-mtext">Hợp đồng</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('admin-contracts.index')}}" class="">Danh sách</a></li>
                    </ul>
                </li>

                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layers"></i></span><span
                            class="pcoded-mtext">Người trung gian</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('admin.traders.index')}}" class="">Danh sách</a></li>
                        <li class=""><a href="{{route('admin.traders.create')}}" class="">Thêm người trung gian</a></li>
                    </ul>
                </li>

                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-layers"></i></span><span
                            class="pcoded-mtext">Cộng đồng</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="{{route('admin.communities.index')}}" class="">Danh sách</a></li>
                        <li class=""><a href="{{route('admin.communities.create')}}" class="">Thêm cộng đồng</a></li>
                    </ul>
                </li>
                ...
                <li data-username="documentation" class="nav-item"><a href="https://html.phoenixcoded.net/dasho/bootstrap/doc/index.html" class="nav-link" target="_blank"><span
                    ...
                    <div class="main-friend-list">
                        <div class="d-flex userlist-box" data-id="1" data-status="online"
                            ...
                            <a class="media-left" href="#!"><img class="media-object img-radius"
                                                                 src="{{asset('assets/images/user/avatar-1.jpg')}}" alt="Profile Image ">
                        ...
                        <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe">
                            <a class="media-left" href="#!"><img class="media-object img-radius"
                                                                 src="{{asset('assets/images/user/avatar-2.jpg')}}" alt="Profile Image">
