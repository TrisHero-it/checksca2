...
@section('content')
    ...
    <div class="col-md-12" id="post">
        <div class="card">
            ...
            <form action="{{route('admin-news.update', $news->id)}}" onsubmit="return checkThegioididong()" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="mb-2">
                        <img src="{{\Illuminate\Support\Facades\Storage::url($news->image)}}" style="max-width: 360px; max-height: 360px" alt="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="title" onkeyup="titleSeo()" type="text" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" value="{{$news->title}}" placeholder="Tiêu đề của tin tức">
                        <div class="thongbao" style="font-size: .875em; color: red"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="exampleInputEmail1"> Từ khoá để tìm kiếm</label>
                        <input name="key_words" onkeyup="keyWordsSeo()" type="text" class="form-control" value="{{$news->keywords}}" placeholder="Từ khoá 1, từ khoá 2, từ   khoá 3,...">
                        <div class="thongbao" style="font-size: .875em; color: red"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="exampleInputEmail1"> Mô tả ngắn</label>
                        <input name="meta" type="text" onkeyup="checkMetaSeo()" class="form-control" value="{{$news->description}}" placeholder="Đoạn mô tả không được vượt quá 156 kí tự">
                        <div class="thongbao" style="font-size: .875em; color: red"></div>
                    </div>
                    ...
                    <div class="mb-3 d-flex">
                        <button class="btn btn-success">Sửa bài viết</button>
                    </div>
    ...
    <script !src="">
        function checkThegioididong() {
            var character = 'thegioididong';
            if (document.getElementsByName('content')[0].value.includes(character)) {
                alert('Sửa hết các link của thế giới di động trước khi đăng')
                return false
            }
                return true
        }
