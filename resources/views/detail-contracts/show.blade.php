...
<div class="cangiua mt-5">
        ...
        <div class="col-8">
            ...
            <div class="border rounded-bottom rounded-end px-3 py-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span style="height:20px" class="badge bg-<?php    if ($contract->status == 'Chờ xử lí')
    echo "secondary";
    ...
    echo "success"; ?>">{{$contract->status}}</span>
                ...
                <div class="d-flex">
                    <button class="btn btn-warning mt-3">Chỉnh sửa hợp đồng</button>
                </div>

            </div>

            <h4 class="mt-5">Đoạn chat với Admin</h4>
            ...
            <div style="padding-top:20px; padding-bottom: 6px;"
                ...
                <form>
                    ...
                    <i id="submit" class="fa-solid fa-paper-plane" style="color: #ffffff;"></i>
                </form>
            </div>
        </div>
